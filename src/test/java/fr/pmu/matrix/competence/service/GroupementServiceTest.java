...
class GroupementServiceTest {
    ...
    void testCreateGroupement() {
        ...
        when(groupementRepository.save(any(GroupementEntity.class))).thenReturn(savedEntity);
        ...
        verify(groupementRepository, times(1)).save(any(GroupementEntity.class));
    }
    ...
    void testUpdateGroupement() {
        ...
        when(groupementRepository.save(any(GroupementEntity.class))).thenReturn(updatedEntity);
