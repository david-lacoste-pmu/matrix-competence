...
public class DemandeurServiceTest {
    ...
    public void testGetPersonnesDisponibles() {
        ...
        List<Profil> result = demandeurService.getPersonnesDisponibles();
    ...
    public void testFiltrerPersonnesParNotes() {
        ...
        // Configuration des mocks
        // Au lieu de mocker demandeurService.getPersonnesDisponibles(), créons un espion pour le service
        DemandeurService spyDemandeurService = spy(demandeurService);
        doReturn(profils).when(spyDemandeurService).getPersonnesDisponibles();
        ...
        List<Personne> result = spyDemandeurService.filtrerPersonnesParNotes(Arrays.asList("Java"), 4);
    ...
    public void testFiltrerPersonnesParCompetences() {
        ...
        List<Personne> result = spyDemandeurService.filtrerPersonnesParCompetences(Arrays.asList("Java", "Angular"));
